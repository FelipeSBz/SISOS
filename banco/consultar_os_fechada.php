...
echo "<input type='text' size='42' name='setor' maxlength='42' value='$setor' disabled=''>&nbsp;&nbsp;</td>";
...
echo "<input type='text' size='42' name='telefone' maxlength='12' value='$telefone' disabled=''></td>";
echo "</tr>";
echo "<tr>";
echo "<td bgcolor='#02679C'><div align='center'>";
echo "	<font face='Arial, Helvetica, sans-serif' size='2' color='#FFFFFF'>*Funcionário:</font></div></td>";
echo "<td bgcolor='#CCCCCC'>";
echo "<input type='text' size='42' name='nome' maxlength='60' value='$funcionario' disabled=''></td>";
echo "<td bgcolor='#02679C'><div align='center'>";
echo "	<font face='Arial, Helvetica, sans-serif' size='2' color='#FFFFFF'>*Patrimonio:</font></div></td>";
echo "<td bgcolor='#CCCCCC'=>";
echo "<input type='text' size='42' name='patrimonio' maxlength='12' value='$patrimonio' disabled=''></td>";
echo "</tr>";
echo "<tr>";
...
echo "<td bgcolor='#CCCCCC'>";
echo "<input type='text' size='42' name='equipamento' maxlength='60' value='$equipamento' disabled=''></td>";
echo "<td bgcolor='#02679C'><div align='center'>";
echo "	<font face='Arial, Helvetica, sans-serif' size='2' color='#FFFFFF'>Tecnico:</font></div></td>";
echo "<td bgcolor='#CCCCCC'>";
echo "<input type='text' size='42' name='tecnico' maxlength='12' value='$tecnico' disabled=''></td>";
echo "</tr>";
echo "<tr>";
echo "<td bgcolor='#02679C'><div align='center'>";
echo "	<font face='Arial, Helvetica, sans-serif' size='2' color='#FFFFFF'>Situação:</font></div></td>";
echo "<td bgcolor='#CCCCCC'>";
echo "<input type='text' size='42' name='situacao' maxlength='20' value='$situacao' disabled=''></td>";
echo "<td bgcolor='#02679C'><div align='center'>";
echo "	<font color='#FFFFFF' size='2' face='Arial, Helvetica, sans-serif'>Data de Entrada:</font></div></td>";
echo "<td bgcolor='#CCCCCC'><input type='text' size='42' name='entrada' maxlength='50' value='$criado_em' disabled=''></td>";
echo "</tr>";
echo "<tr>";
echo "<td width='10%' bgcolor='#02679C'><div align='center'>";
...
echo "<td width='40%' bgcolor='#CCCCCC'>";
echo "<input type='text' size='42' name='saida' maxlength='20' value='$fechado_em' disabled=''></td>";
...
echo "<td width='90%' bgcolor='#CCCCCC'><textarea name='relatado' rows='5' cols='59' disabled='' >$relatado</textarea></td>";
echo "</tr>";
echo "<td width='10%' bgcolor='#02679C'><div align='center'><font color='#FFFFFF' size='2' face='Arial, Helvetica, sans-serif'>";
echo "	*Problema constatado(s):</font></div></td>";
echo "<td width='90%' bgcolor='#CCCCCC'>";
echo "<textarea name='constatado' rows='5' cols='59' disabled=''>$constatado</textarea></td>";
echo "</tr>";
echo "<td width='10%' bgcolor='#02679C'><div align='center'><font color='#FFFFFF' size='2' face='Arial, Helvetica, sans-serif'>";
echo "	*Serviço executado(s):</font></div></td>";
echo "<td width='90%' bgcolor='#CCCCCC'><textarea name='realizado' rows='5' cols='59' disabled=''>$realizado</textarea></td>";
echo "</tr>";
